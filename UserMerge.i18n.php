...
Klikni na "{{int:usermerge-submit}}", aby akceptěrował.',
	...
	'usermerge-same-old-and-new-user' => 'Stare a nowe wužywarske mjenja muse rozdźělne byś.',
...
$messages['fa'] = array(
	...
	'usermerge-unmergable' => 'قادر به ادغام از کاربر نیستː شناسه یا نام به عنوان غیرقابل ادغام تعریف شده‌است.',
	...
	'usermerge-editcount-merge-success' => 'افزودن $1 {{PLURAL:$1|ویرایش|ویرایش‌های}} کاربر $2 به $3 {{PLURAL:$3|ویرایش|ویرایش‌های}} کاربر $4 ($5 {{PLURAL:$5|ویرایش|ویرایش‌های}} پس از ادغام)',
...
Klikń na "{{int:usermerge-submit}}", zo by akceptował.',
	...
	'usermerge-same-old-and-new-user' => 'Stare a nowe wužiwarske mjena dyrbja so rozeznawać.',
...
Klicka på "{{int:usermerge-submit}}" för att godkänna.',
	...
	'usermerge-editcount-merge-success' => 'Lägger till $1 {{PLURAL:$1|redigering|redigeringar}} av användaren $2 till $3 {{PLURAL:$3|redigering|redigeringar}} av användaren $4 ($5 {{PLURAL:$5|redigering|redigeringar}} efter hopslagningen)',
